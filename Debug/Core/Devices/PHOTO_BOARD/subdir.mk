...
C_SRCS += \
../Core/Devices/PHOTO_BOARD/photo_board.c 

OBJS += \
./Core/Devices/PHOTO_BOARD/photo_board.o 

C_DEPS += \
./Core/Devices/PHOTO_BOARD/photo_board.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Devices/PHOTO_BOARD/%.o Core/Devices/PHOTO_BOARD/%.su Core/Devices/PHOTO_BOARD/%.cyclo: ../Core/Devices/PHOTO_BOARD/%.c Core/Devices/PHOTO_BOARD/subdir.mk
...
clean: clean-Core-2f-Devices-2f-PHOTO_BOARD

clean-Core-2f-Devices-2f-PHOTO_BOARD:
	-$(RM) ./Core/Devices/PHOTO_BOARD/photo_board.cyclo ./Core/Devices/PHOTO_BOARD/photo_board.d ./Core/Devices/PHOTO_BOARD/photo_board.o ./Core/Devices/PHOTO_BOARD/photo_board.su

.PHONY: clean-Core-2f-Devices-2f-PHOTO_BOARD
