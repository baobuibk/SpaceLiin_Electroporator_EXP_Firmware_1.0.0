...
C_SRCS += \
../Core/Devices/LASER_BOARD/laser_board.c 

OBJS += \
./Core/Devices/LASER_BOARD/laser_board.o 

C_DEPS += \
./Core/Devices/LASER_BOARD/laser_board.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Devices/LASER_BOARD/%.o Core/Devices/LASER_BOARD/%.su Core/Devices/LASER_BOARD/%.cyclo: ../Core/Devices/LASER_BOARD/%.c Core/Devices/LASER_BOARD/subdir.mk
...
clean: clean-Core-2f-Devices-2f-LASER_BOARD

clean-Core-2f-Devices-2f-LASER_BOARD:
	-$(RM) ./Core/Devices/LASER_BOARD/laser_board.cyclo ./Core/Devices/LASER_BOARD/laser_board.d ./Core/Devices/LASER_BOARD/laser_board.o ./Core/Devices/LASER_BOARD/laser_board.su

.PHONY: clean-Core-2f-Devices-2f-LASER_BOARD
