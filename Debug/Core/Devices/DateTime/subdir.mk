...
C_SRCS += \
../Core/Devices/DateTime/date_time.c 

OBJS += \
./Core/Devices/DateTime/date_time.o 

C_DEPS += \
./Core/Devices/DateTime/date_time.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Devices/DateTime/%.o Core/Devices/DateTime/%.su Core/Devices/DateTime/%.cyclo: ../Core/Devices/DateTime/%.c Core/Devices/DateTime/subdir.mk
...
clean: clean-Core-2f-Devices-2f-DateTime

clean-Core-2f-Devices-2f-DateTime:
	-$(RM) ./Core/Devices/DateTime/date_time.cyclo ./Core/Devices/DateTime/date_time.d ./Core/Devices/DateTime/date_time.o ./Core/Devices/DateTime/date_time.su

.PHONY: clean-Core-2f-Devices-2f-DateTime
