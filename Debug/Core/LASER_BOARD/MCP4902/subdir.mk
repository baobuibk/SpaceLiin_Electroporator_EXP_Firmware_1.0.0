...
C_SRCS += \
../Core/LASER_BOARD/MCP4902/mcp4902.c 

OBJS += \
./Core/LASER_BOARD/MCP4902/mcp4902.o 

C_DEPS += \
./Core/LASER_BOARD/MCP4902/mcp4902.d 


# Each subdirectory must supply rules for building sources it contributes
Core/LASER_BOARD/MCP4902/%.o Core/LASER_BOARD/MCP4902/%.su Core/LASER_BOARD/MCP4902/%.cyclo: ../Core/LASER_BOARD/MCP4902/%.c Core/LASER_BOARD/MCP4902/subdir.mk
...
clean: clean-Core-2f-LASER_BOARD-2f-MCP4902

clean-Core-2f-LASER_BOARD-2f-MCP4902:
	-$(RM) ./Core/LASER_BOARD/MCP4902/mcp4902.cyclo ./Core/LASER_BOARD/MCP4902/mcp4902.d ./Core/LASER_BOARD/MCP4902/mcp4902.o ./Core/LASER_BOARD/MCP4902/mcp4902.su

.PHONY: clean-Core-2f-LASER_BOARD-2f-MCP4902
