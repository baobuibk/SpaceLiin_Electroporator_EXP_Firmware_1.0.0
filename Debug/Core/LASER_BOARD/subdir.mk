...
C_SRCS += \
../Core/LASER_BOARD/laser_board.c 

OBJS += \
./Core/LASER_BOARD/laser_board.o 

C_DEPS += \
./Core/LASER_BOARD/laser_board.d 


# Each subdirectory must supply rules for building sources it contributes
Core/LASER_BOARD/%.o Core/LASER_BOARD/%.su Core/LASER_BOARD/%.cyclo: ../Core/LASER_BOARD/%.c Core/LASER_BOARD/subdir.mk
...
clean: clean-Core-2f-LASER_BOARD

clean-Core-2f-LASER_BOARD:
	-$(RM) ./Core/LASER_BOARD/laser_board.cyclo ./Core/LASER_BOARD/laser_board.d ./Core/LASER_BOARD/laser_board.o ./Core/LASER_BOARD/laser_board.su

.PHONY: clean-Core-2f-LASER_BOARD
