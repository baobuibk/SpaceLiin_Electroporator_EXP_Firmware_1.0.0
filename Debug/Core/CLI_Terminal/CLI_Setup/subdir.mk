...
C_DEPS += \
./Core/CLI_Terminal/CLI_Setup/cli_setup.d 


# Each subdirectory must supply rules for building sources it contributes
Core/CLI_Terminal/CLI_Setup/%.o Core/CLI_Terminal/CLI_Setup/%.su Core/CLI_Terminal/CLI_Setup/%.cyclo: ../Core/CLI_Terminal/CLI_Setup/%.c Core/CLI_Terminal/CLI_Setup/subdir.mk
...
clean: clean-Core-2f-CLI_Terminal-2f-CLI_Setup

clean-Core-2f-CLI_Terminal-2f-CLI_Setup:
	-$(RM) ./Core/CLI_Terminal/CLI_Setup/cli_setup.cyclo ./Core/CLI_Terminal/CLI_Setup/cli_setup.d ./Core/CLI_Terminal/CLI_Setup/cli_setup.o ./Core/CLI_Terminal/CLI_Setup/cli_setup.su

.PHONY: clean-Core-2f-CLI_Terminal-2f-CLI_Setup
