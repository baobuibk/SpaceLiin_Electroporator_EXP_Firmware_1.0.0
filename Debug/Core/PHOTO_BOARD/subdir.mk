...
C_SRCS += \
../Core/PHOTO_BOARD/photo_board.c 

OBJS += \
./Core/PHOTO_BOARD/photo_board.o 

C_DEPS += \
./Core/PHOTO_BOARD/photo_board.d 


# Each subdirectory must supply rules for building sources it contributes
Core/PHOTO_BOARD/%.o Core/PHOTO_BOARD/%.su Core/PHOTO_BOARD/%.cyclo: ../Core/PHOTO_BOARD/%.c Core/PHOTO_BOARD/subdir.mk
...
clean: clean-Core-2f-PHOTO_BOARD

clean-Core-2f-PHOTO_BOARD:
	-$(RM) ./Core/PHOTO_BOARD/photo_board.cyclo ./Core/PHOTO_BOARD/photo_board.d ./Core/PHOTO_BOARD/photo_board.o ./Core/PHOTO_BOARD/photo_board.su

.PHONY: clean-Core-2f-PHOTO_BOARD
