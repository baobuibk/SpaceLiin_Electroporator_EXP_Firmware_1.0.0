...
Core/COPC/%.o Core/COPC/%.su Core/COPC/%.cyclo: ../Core/COPC/%.c Core/COPC/subdir.mk
...
clean: clean-Core-2f-COPC

clean-Core-2f-COPC:
	-$(RM) ./Core/COPC/copc.cyclo ./Core/COPC/copc.d ./Core/COPC/copc.o ./Core/COPC/copc.su

.PHONY: clean-Core-2f-COPC
