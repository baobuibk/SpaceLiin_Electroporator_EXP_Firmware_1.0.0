...
C_SRCS += \
../Core/Sensor_I2C/K33/k33.c 

OBJS += \
./Core/Sensor_I2C/K33/k33.o 

C_DEPS += \
./Core/Sensor_I2C/K33/k33.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Sensor_I2C/K33/%.o Core/Sensor_I2C/K33/%.su Core/Sensor_I2C/K33/%.cyclo: ../Core/Sensor_I2C/K33/%.c Core/Sensor_I2C/K33/subdir.mk
...
clean: clean-Core-2f-Sensor_I2C-2f-K33

clean-Core-2f-Sensor_I2C-2f-K33:
	-$(RM) ./Core/Sensor_I2C/K33/k33.cyclo ./Core/Sensor_I2C/K33/k33.d ./Core/Sensor_I2C/K33/k33.o ./Core/Sensor_I2C/K33/k33.su

.PHONY: clean-Core-2f-Sensor_I2C-2f-K33
