...
C_SRCS += \
../Core/Sensor_I2C/BME280/bme280.c 

OBJS += \
./Core/Sensor_I2C/BME280/bme280.o 

C_DEPS += \
./Core/Sensor_I2C/BME280/bme280.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Sensor_I2C/BME280/%.o Core/Sensor_I2C/BME280/%.su Core/Sensor_I2C/BME280/%.cyclo: ../Core/Sensor_I2C/BME280/%.c Core/Sensor_I2C/BME280/subdir.mk
...
clean: clean-Core-2f-Sensor_I2C-2f-BME280

clean-Core-2f-Sensor_I2C-2f-BME280:
	-$(RM) ./Core/Sensor_I2C/BME280/bme280.cyclo ./Core/Sensor_I2C/BME280/bme280.d ./Core/Sensor_I2C/BME280/bme280.o ./Core/Sensor_I2C/BME280/bme280.su

.PHONY: clean-Core-2f-Sensor_I2C-2f-BME280
