...
C_SRCS += \
../Core/Sensor_I2C/sensor_i2c.c 

OBJS += \
./Core/Sensor_I2C/sensor_i2c.o 

C_DEPS += \
./Core/Sensor_I2C/sensor_i2c.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Sensor_I2C/%.o Core/Sensor_I2C/%.su Core/Sensor_I2C/%.cyclo: ../Core/Sensor_I2C/%.c Core/Sensor_I2C/subdir.mk
...
clean: clean-Core-2f-Sensor_I2C

clean-Core-2f-Sensor_I2C:
	-$(RM) ./Core/Sensor_I2C/sensor_i2c.cyclo ./Core/Sensor_I2C/sensor_i2c.d ./Core/Sensor_I2C/sensor_i2c.o ./Core/Sensor_I2C/sensor_i2c.su

.PHONY: clean-Core-2f-Sensor_I2C
