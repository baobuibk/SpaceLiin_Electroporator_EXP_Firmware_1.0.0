...
C_SRCS += \
../Core/Temperature/NTC/ntc.c 

OBJS += \
./Core/Temperature/NTC/ntc.o 

C_DEPS += \
./Core/Temperature/NTC/ntc.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Temperature/NTC/%.o Core/Temperature/NTC/%.su Core/Temperature/NTC/%.cyclo: ../Core/Temperature/NTC/%.c Core/Temperature/NTC/subdir.mk
...
clean: clean-Core-2f-Temperature-2f-NTC

clean-Core-2f-Temperature-2f-NTC:
	-$(RM) ./Core/Temperature/NTC/ntc.cyclo ./Core/Temperature/NTC/ntc.d ./Core/Temperature/NTC/ntc.o ./Core/Temperature/NTC/ntc.su

.PHONY: clean-Core-2f-Temperature-2f-NTC
