...
C_SRCS += \
../Core/Temperature/Heater/heater.c 

OBJS += \
./Core/Temperature/Heater/heater.o 

C_DEPS += \
./Core/Temperature/Heater/heater.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Temperature/Heater/%.o Core/Temperature/Heater/%.su Core/Temperature/Heater/%.cyclo: ../Core/Temperature/Heater/%.c Core/Temperature/Heater/subdir.mk
...
clean: clean-Core-2f-Temperature-2f-Heater

clean-Core-2f-Temperature-2f-Heater:
	-$(RM) ./Core/Temperature/Heater/heater.cyclo ./Core/Temperature/Heater/heater.d ./Core/Temperature/Heater/heater.o ./Core/Temperature/Heater/heater.su

.PHONY: clean-Core-2f-Temperature-2f-Heater
