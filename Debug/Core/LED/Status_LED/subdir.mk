...
C_SRCS += \
../Core/LED/Status_LED/status_led.c 

OBJS += \
./Core/LED/Status_LED/status_led.o 

C_DEPS += \
./Core/LED/Status_LED/status_led.d 


# Each subdirectory must supply rules for building sources it contributes
Core/LED/Status_LED/%.o Core/LED/Status_LED/%.su Core/LED/Status_LED/%.cyclo: ../Core/LED/Status_LED/%.c Core/LED/Status_LED/subdir.mk
...
clean: clean-Core-2f-LED-2f-Status_LED

clean-Core-2f-LED-2f-Status_LED:
	-$(RM) ./Core/LED/Status_LED/status_led.cyclo ./Core/LED/Status_LED/status_led.d ./Core/LED/Status_LED/status_led.o ./Core/LED/Status_LED/status_led.su

.PHONY: clean-Core-2f-LED-2f-Status_LED
