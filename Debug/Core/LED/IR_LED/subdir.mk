...
C_SRCS += \
../Core/LED/IR_LED/ir_led.c 

OBJS += \
./Core/LED/IR_LED/ir_led.o 

C_DEPS += \
./Core/LED/IR_LED/ir_led.d 


# Each subdirectory must supply rules for building sources it contributes
Core/LED/IR_LED/%.o Core/LED/IR_LED/%.su Core/LED/IR_LED/%.cyclo: ../Core/LED/IR_LED/%.c Core/LED/IR_LED/subdir.mk
...
clean: clean-Core-2f-LED-2f-IR_LED

clean-Core-2f-LED-2f-IR_LED:
	-$(RM) ./Core/LED/IR_LED/ir_led.cyclo ./Core/LED/IR_LED/ir_led.d ./Core/LED/IR_LED/ir_led.o ./Core/LED/IR_LED/ir_led.su

.PHONY: clean-Core-2f-LED-2f-IR_LED
