...
USART_TypeDef *usart1 = USART1;				//RS485 Interface
USART_TypeDef *usart6 = USART6;				//Debug Interface
...
unsigned char usart6_rx_data[USART6_BUFFER_SIZE];
unsigned char usart6_tx_data[USART6_BUFFER_SIZE];
...
USART_Buffer usart_buffers[USART_COUNT] = {
    ...
    {
        USART6,
        { usart6_rx_data, 0, 0, USART6_BUFFER_SIZE },
        { usart6_tx_data, 0, 0, USART6_BUFFER_SIZE }
    }
};
